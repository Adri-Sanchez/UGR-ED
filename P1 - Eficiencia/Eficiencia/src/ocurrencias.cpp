 ...
 */
// Esta función no se usa para nada
...
int main() {
   ...
   // No queremos que muestre por pantalla mas que el tamaño seguido por el tiemp
   // Asi que comento el resto
