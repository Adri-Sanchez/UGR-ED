...
public:
	...
	*/
	...
	@post no modifica el conjunto.
	*/
	conjunto::iterator lower_bound (const str & chr, const unsigned int & pos) ; 
	...
	@param[in] pos de la mutación.
	@param[in] e entrada. 
	@return Devuelve un iterador al primer elemento que cumple que "elemento>e", esto es, el primer elemento ESTRICTAMENTE mayor que e

	Si no existe devuelve end
	@post no modifica el conjunto.
	*/
	conjunto::iterator upper_bound (const str & chr, const unsigned int & pos) ; 
...
private:
  ...
  */
  ...
  conjunto::const_iterator posicion(const str &chr, const unsigned int &pos) const;
  conjunto::const_iterator posicion(const str & ID) const;
  conjunto::const_iterator posicion(const conjunto::value_type &e) const;
